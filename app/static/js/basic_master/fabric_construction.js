const FabricConstructionForm =
{
    template: "#fabric_construction_form",
    data() {
        return {
            view: true,
            form: {
    ...
    methods: {
        ...
        submitData(e) {
            ...
            if (this.checkData()) {
                ...
                axios
                    .post('/basic_master/add/fabric_construction', this.form)
        ...
        getData(e) {
            ...
            axios
                .get('/basic_master/get/fabric_construction')
                .then(function (response) {
        ...
        saveEditData(e) {
            ...
            if (this.edit.name) {
                ...
                axios
                    .post('/basic_master/edit/fabric_construction', this.edit)
                    .then(function (response) {
        ...
        deleteData(data, index) {
            ...
            let formdata = this
            axios
                .post('/basic_master/delete/fabric_construction', data)
                .then(function (response) {
                    if (response.data.success) {
