        ...
        methods: {
            ...
            submitData(e) {
                ...
                if (this.checkData()) {
                    ...
                    axios
                        .post('/basic_master/add/department', this.form)
            ...
            getData(e) {
                ...
                axios
                    .get('/basic_master/get/department')
                    .then(function (response) {
            ...
            saveEditData(e) {
                ...
                if (this.edit.name) {
                    ...
                    axios
                        .post('/basic_master/edit/department', this.edit)
                        .then(function (response) {
            ...
            deleteData(data, index) {
                ...
                let formdata = this
                axios
                    .post('/basic_master/delete/department', data)
                    .then(function (response) {
                        if (response.data.success) {
