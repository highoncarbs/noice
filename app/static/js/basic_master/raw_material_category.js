const RawMaterialCategoryForm =
{
    template: "#raw_material_category_form",
    data() {
        return {
            view: true,
            form: {
    ...
    methods: {
        ...
        submitData(e) {
            ...
            if (this.checkData()) {
                ...
                axios
                    .post('/basic_master/add/raw_material_category', this.form)
        ...
        getData(e) {
            ...
            axios
                .get('/basic_master/get/raw_material_category')
                .then(function (response) {
        ...
        saveEditData(e) {
            ...
            if (this.edit.name) {
                ...
                axios
                    .post('/basic_master/edit/raw_material_category', this.edit)
                    .then(function (response) {
        ...
        deleteData(data, index) {
            ...
            let formdata = this
            axios
                .post('/basic_master/delete/raw_material_category', data)
                .then(function (response) {
                    if (response.data.success) {
